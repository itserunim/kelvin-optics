...
export default function WorldChat() {
  ...
  const [authMode, setAuthMode] = useState<'register' | 'login'>('register'); // Registration first
  ...
  // AUTH SCREEN (Registration or Login)
  if (!isLoggedIn) {
    return (
          ...
          {authMode === 'register' ? (
            <>
              ...
              <form onSubmit={handleRegister} className="flex flex-col gap-6">
                ...
                <button
                  type="submit"
                  className="bg-[#e0e5ec] font-bold text-slate-600 py-3 rounded-xl shadow-[6px_6px_12px_#a3b1c6,-6px_-6px_12px_#ffffff] active:shadow-[inset_4px_4px_8px_#a3b1c6,inset_-4px_-4px_8px_#ffffff] transition-all"
                >
                  Register
                </button>
                <p className="text-center text-sm text-slate-500">
                  ...
                  <button
                    ...
                    className="underline text-slate-600 font-semibold hover:text-slate-800 focus:outline-none"
                  >
                    Sign In
                  </button>
                </p>
